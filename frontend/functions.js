...
export const getFormattedCart = (data) => {
    ...
    for (let i = 0; i < givenProducts.length; i++) {
        ...
        product.image = {
            sourceUrl: givenProduct.image ? givenProduct.image.sourceUrl : '',
            srcSet: givenProduct.image ? givenProduct.image.srcSet : '',
            title: givenProduct.image ? givenProduct.image.title : ''
        };
